...
<head>
    ...
    <title>Create Item Master - DSL Barcode System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <!-- Menu -->
        <div class="menu">
            <button type="button" onclick="document.querySelector('form').submit()">SAVE</button>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('item.store') }}" id="itemForm">
                @csrf

                <!-- IMAS CODE -->
                <div class="form-group">
                    <label for="imas_code">ITEM CODE <span style="color: red;">*</span></label>
                    <input type="text" id="imas_code" name="itmcode" placeholder="Enter item code" required>
                    @error('itmcode')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="item_name" name="itmnme" placeholder="Enter item name" required>
                    @error('itmnme')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="item_model" name="itmmod" placeholder="Enter item model">
                        @error('itmmod')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" id="ampere" name="itmamp" placeholder="Enter ampere rating">
                        @error('itmamp')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="full_warranty" name="f_war" placeholder="Enter warranty period in months" min="0">
                        @error('f_war')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" id="pro_rata_warranty" name="pa_war" placeholder="Enter pro-rata period in months" min="0">
                        @error('pa_war')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="printed_term" name="prphase" placeholder="Enter printed term details">
                        @error('prphase')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="remarks" name="remark" placeholder="Enter any additional remarks or notes"></textarea>
                    @error('remark')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <script>
        // Auto-populate uppercase for IMAS CODE
        document.getElementById('imas_code').addEventListener('input', function() {
